        ...
        <div className="w-full max-w-3xl text-center" style={{ paddingLeft: '32px', paddingRight: '32px' }}>
          ...
          >
            ...
            <div className="flex items-center" style={{ gap: '16px' }}>
              <a
                href="https://www.instagram.com/initio.sa"
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full border border-white/[0.08] bg-white/[0.03] flex items-center justify-center text-[#D4D4D4]/60 hover:text-[#71B8E3] hover:border-[#71B8E3]/30 hover:bg-[#71B8E3]/[0.06] transition-all duration-300"
              ...
              <a
                href="https://www.linkedin.com/company/initio-sa"
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full border border-white/[0.08] bg-white/[0.03] flex items-center justify-center text-[#D4D4D4]/60 hover:text-[#71B8E3] hover:border-[#71B8E3]/30 hover:bg-[#71B8E3]/[0.06] transition-all duration-300"
                aria-label="LinkedIn"
              ...
              <a
                href="https://www.facebook.com/initio.sa"
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-full border border-white/[0.08] bg-white/[0.03] flex items-center justify-center text-[#D4D4D4]/60 hover:text-[#71B8E3] hover:border-[#71B8E3]/30 hover:bg-[#71B8E3]/[0.06] transition-all duration-300"
                aria-label="Facebook"
